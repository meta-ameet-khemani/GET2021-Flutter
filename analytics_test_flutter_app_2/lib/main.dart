...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() async {
    await widget.analytics.logEvent(name: 'increment_event');
    await _sendAnalyticsEvent();
    await _testSetUserId();
    await _testSetCurrentScreen();
    await _testSetAnalyticsCollectionEnabled();
    await _testSetSessionTimeoutDuration();
    await _testSetUserProperty();
    await _testAllEventTypes();
    setState(() {
      _counter++;
    });
  }

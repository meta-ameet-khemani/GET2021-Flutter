...
class Chart extends StatelessWidget {
  ...
  List<Widget> getChart() {
    ...
    for (var index = 0; index < lastTransactions.length; index++) {
      ...
      if (dayExpense.containsKey(DateFormat.E()
    ...
    dayExpense.forEach((key, value) {
      weeklyExpense.add({key: value});
    });
    List<Widget> allDaysExpenses = [];
    for (var a = 0; a < 7; a++) {
      allDaysExpenses.add(Container(
        child: Column(
          children: [
              ...
              child: Stack(
                children: [
                  ...
                  FractionallySizedBox(
                    heightFactor: weeklyExpense[a][days[a]]! > 0
                        ? weeklyExpense[a][days[a]]! / totalExpense
                        : 0,
                    child: Container(
                      decoration: BoxDecoration(
                        color: Colors.purple,
